...
#define TASK_EVENT_BOUCLE_RELEASE     (TASK_EVENT_1 | TASK_EVENT_2)

#define TASK_EVENT_PERIPH_TRIGGER     TASK_EVENT_1
#define TASK_EVENT_PERIPH_WAIT        TASK_EVENT_2

#define TASK_EVENT_LS027_TRIGGER      TASK_EVENT_1
#define TASK_EVENT_LS027_WAIT         TASK_EVENT_2
