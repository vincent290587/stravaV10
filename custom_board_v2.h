...
#define LS027_CS_PIN      NRF_GPIO_PIN_MAP(0, 24)

#define QSPI_MISO_PIN     NRF_GPIO_PIN_MAP(0, 10)
#define QSPI_MOSI_PIN     NRF_GPIO_PIN_MAP(1, 2)
#define QSPI_SCK_PIN      NRF_GPIO_PIN_MAP(1, 4)
#define QSPI_SS_PIN       NRF_GPIO_PIN_MAP(1, 6)
#define QSPI_IO2_PIN      NRF_GPIO_PIN_MAP(0, 9)
#define QSPI_IO3_PIN      NRF_GPIO_PIN_MAP(1, 0)

#define FXOS_INT1         NRF_GPIO_PIN_MAP(0, 29)
#define FXOS_RST          NRF_GPIO_PIN_MAP(0, 2)

#define BCK_PIN           NRF_GPIO_PIN_MAP(1, 1)

#define GPS_R             NRF_GPIO_PIN_MAP(0, 4)
#define GPS_S             NRF_GPIO_PIN_MAP(0, 6)
#define FIX_PIN           NRF_GPIO_PIN_MAP(0, 8)

#define KILL_PIN          NRF_GPIO_PIN_MAP(1, 10)

#define NEO_PIN           NRF_GPIO_PIN_MAP(0, 26)
