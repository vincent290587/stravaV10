...
#ifndef PACKED
//#define PACKED __attribute__((aligned (FIT_ALIGNMENT)))
...
#define FIT_MANUFACTURER_COUNT                                                   177
...
typedef struct PACKED
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SESSION_USER_MSG_FIELDS_NB * FIT_FIELD_DEF_SIZE];
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_LAP_USER_MSG_FIELDS_NB * FIT_FIELD_DEF_SIZE];
} FIT_LAP_MESG_DEF;
...
#define FIT_RECORD_MESG_SIZE                                                    19
#define FIT_RECORD_MESG_DEF_SIZE                                                ((FIT_RECORD_FIELDS_IN_USE*FIT_FIELD_DEF_SIZE)+5)
#define FIT_RECORD_MESG_COMPRESSED_SPEED_DISTANCE_COUNT                         3
#define FIT_RECORD_MESG_SPEED_1S_COUNT                                          5

// TODO custom that
#define FIT_RECORD_FIELDS_IN_USE             8
...
typedef struct PACKED
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_RECORD_FIELDS_IN_USE * FIT_FIELD_DEF_SIZE];
} FIT_RECORD_MESG_DEF;
...
typedef struct
{
   ...
   FIT_UINT16 timestamp_ms; // 1 * ms + 0, Fractional part of timestamp, added to timestamp
   FIT_SINT16 pitch[FIT_AVIATION_ATTITUDE_MESG_PITCH_COUNT]; // 1 * radians + 0, Range -PI/2 to +PI/2
   FIT_SINT16 roll[FIT_AVIATION_ATTITUDE_MESG_ROLL_COUNT]; // 1 * radians + 0, Range -PI to +PI
   ...
   FIT_UINT16 track[FIT_AVIATION_ATTITUDE_MESG_TRACK_COUNT]; // 1 * radians + 0, Track Angle/Heading Range 0 - 2pi
