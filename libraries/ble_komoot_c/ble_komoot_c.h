...
/**@file
 *
 * @defgroup ble_komoot_c Heart Rate Service Client
 * @{
 * @ingroup  ble_sdk_srv
 ...
 *           ble_komoot_c_on_ble_evt().
 *
 */

#ifndef BLE_KOMOOT_C_H__
#define BLE_KOMOOT_C_H__
...
#define BLE_KOMOOT_C_BLE_OBSERVER_PRIO    2

#define BLE_KOMOOT_INVALID_DATA           (-1)

#define BLE_BASE_UUID_KOMOOT_SERVICE            {0x6C,0x43,0xB3,0x1D,0x17,0x0F,0xB2,0xA2, \
												 0xA8,0x4F,0x2F,0xD9,0x28,0xE1,0xC1,0x71}

#define BLE_BASE_UUID_KOMOOT_CHAR               {0x26,0x30,0x48,0x57,0x0A,0x27,0x35,0xB2, \
													0x6E,0x4F,0xCB,0x9B,0x05,0xD6,0x3D,0x50}

#define BLE_UUID_KOMOOT_SERVICE                 0xE128     /**< Komoot service UUID. */
#define BLE_UUID_KOMOOT_CHAR                    0x0000     /**< Komoot characteristic UUID. */
 ...
 * @hideinitializer
 */
#define BLE_KOMOOT_C_DEF(_name)                                                                        \
static ble_komoot_c_t _name;                                                                           \
...
/**@brief KOMOOT Client event type. */
typedef enum
{
...
/**
 * @defgroup komoot_c_structs Structures
 * @{
 */
...
typedef struct
{
    ble_komoot_c_evt_type_t evt_type;    /**< Type of the event. */
    uint16_t             conn_handle; /**< Connection handle on which the Heart Rate service was discovered on the peer device..*/
    union
    {
        komoot_db_t  peer_db;            /**< KOMOOT related handles found on the peer device.. This will be filled if the evt_type is @ref BLE_KOMOOT_C_EVT_DISCOVERY_COMPLETE.*/
        ble_komoot_t komoot;                /**< KOMOOT measurement received. This will be filled if the evt_type is @ref BLE_KOMOOT_C_EVT_NOTIFICATION. */
    } params;
} ble_komoot_c_evt_t;
...
/**
 * @defgroup komoot_c_types Types
 * @{
 */

// Forward declaration of the ble_bas_t type.
typedef struct ble_komoot_c_s ble_komoot_c_t;
 ...
 */
typedef void (* ble_komoot_c_evt_handler_t) (ble_komoot_c_t * p_ble_komoot_c, ble_komoot_c_evt_t * p_evt);

/** @} */

/**
 * @addtogroup komoot_c_structs
 * @{
 */

/**@brief Heart Rate Client structure.
 */
struct ble_komoot_c_s
{
...
/**
 * @defgroup komoot_c_functions Functions
 * @{
 */
 ...
 * @param[in] p_ble_komoot_c_init Pointer to the heart rate initialization structure containing the
 ...
 *
 * @param   p_ble_komoot_c Pointer to the heart rate client structure.
 *
 ...
 *
 * @param[in] p_ble_komoot_c Pointer to the heart rate client structure instance to associate.
...
/**@brief     Function for assigning a handles to a this instance of komoot_c.
 *
 ...
 *            provided from the discovery event @ref BLE_KOMOOT_C_EVT_DISCOVERY_COMPLETE.
 *
 * @param[in] p_ble_komoot_c        Pointer to the heart rate client structure instance to associate.
 * @param[in] conn_handle        Connection handle to associated with the given Heart Rate Client Instance.
 * @param[in] p_peer_komoot_handles Attribute handles for the KOMOOT server you want this KOMOOT_C client to
 *                               interact with.
 */
